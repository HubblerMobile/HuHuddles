...
Pod::Spec.new do |s|
  s.name             = 'HuHuddles'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HuHuddles.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/priyamdutta/HuHuddles'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'priyamdutta' => 'priyam.sm93@gmail.com' }
  s.source           = { :git => 'https://github.com/priyamdutta/HuHuddles.git', :tag => s.version.to_s }
